...
function Test-PHGServiceConflict {
    return [bool](Get-Service -Name "phglive" -ErrorAction SilentlyContinue)
}
...
if (Test-PHGServiceConflict) {
    Write-Host "[ERROR] Windows service 'phglive' is installed" -ForegroundColor Red
...
Write-Host "                 PHG LIVE CONFIG TESTS" -ForegroundColor Cyan
